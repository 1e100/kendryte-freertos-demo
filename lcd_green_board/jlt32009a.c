...
void spi_control_init() {
  ...
  configASSERT(spi0);
  spi_dfs8 = spi_get_device(spi0, SPI_MODE_2, SPI_FF_OCTAL,
  ...
  spi_dfs16 = spi_get_device(spi0, SPI_MODE_2, SPI_FF_OCTAL,
                             1 << SPI_SLAVE_SELECT, FRAME_LEN_16);
  spi_dev_config_non_standard(spi_dfs16, INSTRUCTION_LEN_16, ADDRESS_LEN_0,
                              WAIT_CYCLE, SPI_AITM_AS_FRAME_FORMAT);

  spi_dfs32 = spi_get_device(spi0, SPI_MODE_2, SPI_FF_OCTAL,
