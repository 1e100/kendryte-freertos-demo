...
void sd3068_init(uintptr_t i2c_dr) { i2c_adapter = i2c_dr; }

static uint8_t hex2bcd(uint8_t data) { return data / 10 * 16 + data % 10; }

static uint8_t bcd2hex(uint8_t data) { return data / 16 * 10 + data % 16; }
