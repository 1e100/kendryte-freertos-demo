...
/// specialisation of the \ref FunctorExtractor struct when the node type does
...
#define SYCLEXTRFUNCCONVERSION(ExprNode, CVQual)                               \
  ...
  struct FunctorExtractor<                                                     \
      TensorEvaluator<CVQual ExprNode<ArgType1, ArgType2>, Dev>> {             \
    FunctorExtractor<TensorEvaluator<ArgType2, Dev>> subExpr;                  \
    FunctorExtractor(                                                          \
        const TensorEvaluator<CVQual ExprNode<ArgType1, ArgType2>, Dev>& expr) \
        : subExpr(expr.impl()) {}                                              \
  };
...
#define SYCLEXTRTENSORMAPFIXEDSIZE(CVQual)                                    \
  template <typename Scalar_, typename Dimensions_, int Options_2,            \
            ...
            template <class> class MakePointer_, typename Dev>                \
  struct FunctorExtractor<                                                    \
      TensorEvaluator<CVQual TensorMap<TensorFixedSize<Scalar_, Dimensions_,  \
                                                       Options_2, IndexType>, \
                                       Options_, MakePointer_>,               \
                      Dev>> {                                                 \
    FunctorExtractor(const TensorEvaluator<                                   \
                     CVQual TensorMap<TensorFixedSize<Scalar_, Dimensions_,   \
                                                      Options_2, IndexType>,  \
                                      Options_, MakePointer_>,                \
                     Dev>&) {}                                                \
  };
...
#define SYCLEXTRFUNCUNARY(CVQual)                                            \
  ...
  struct FunctorExtractor<                                                   \
      TensorEvaluator<CVQual UnaryCategory<OP, RHSExpr>, Dev>> {             \
    FunctorExtractor<TensorEvaluator<RHSExpr, Dev>> rhsExpr;                 \
    const OP func;                                                           \
    FunctorExtractor(                                                        \
        const TensorEvaluator<CVQual UnaryCategory<OP, RHSExpr>, Dev>& expr) \
...
#define SYCLEXTRFUNCBIINARY(CVQual)                                           \
  ...
  struct FunctorExtractor<                                                    \
      TensorEvaluator<CVQual BinaryCategory<OP, LHSExpr, RHSExpr>, Dev>> {    \
    FunctorExtractor<TensorEvaluator<LHSExpr, Dev>> lhsExpr;                  \
    FunctorExtractor<TensorEvaluator<RHSExpr, Dev>> rhsExpr;                  \
    const OP func;                                                            \
    FunctorExtractor(const TensorEvaluator<                                   \
                     CVQual BinaryCategory<OP, LHSExpr, RHSExpr>, Dev>& expr) \
...
#define SYCLEXTRFUNCTERNARY(CVQual)                                            \
  template <template <class, class, class, class> class TernaryCategory,       \
            typename OP, typename Arg1Expr, typename Arg2Expr,                 \
            typename Arg3Expr, typename Dev>                                   \
  struct FunctorExtractor<TensorEvaluator<                                     \
      CVQual TernaryCategory<OP, Arg1Expr, Arg2Expr, Arg3Expr>, Dev>> {        \
...
// TensorCustomOp must be specialised otherwise it will be captured by
// UnaryCategory while its action is different from the UnaryCategory and it is
// similar to the general FunctorExtractor.
...
#define SYCLEXTRFUNCCUSTOMUNARYOP(CVQual)                             \
  ...
  struct FunctorExtractor<TensorEvaluator<                            \
      CVQual TensorCustomUnaryOp<CustomUnaryFunc, ArgType>, Dev>> {   \
...
#define SYCLEXTRFUNCCUSTOMBIBARYOP(CVQual)                                   \
  template <typename CustomBinaryFunc, typename ArgType1, typename ArgType2, \
            typename Dev>                                                    \
  struct FunctorExtractor<TensorEvaluator<                                   \
      CVQual TensorCustomBinaryOp<CustomBinaryFunc, ArgType1, ArgType2>,     \
      Dev>> {                                                                \
    typedef TensorEvaluator<                                                 \
        CVQual TensorCustomBinaryOp<CustomBinaryFunc, ArgType1, ArgType2>,   \
        Dev>                                                                 \
...
#define SYCLEXTRFUNCSELECTOP(CVQual)                                       \
  template <typename IfExpr, typename ThenExpr, typename ElseExpr,         \
            typename Dev>                                                  \
  struct FunctorExtractor<TensorEvaluator<                                 \
      CVQual TensorSelectOp<IfExpr, ThenExpr, ElseExpr>, Dev>> {           \
    ...
    FunctorExtractor(                                                      \
        const TensorEvaluator<                                             \
            CVQual TensorSelectOp<IfExpr, ThenExpr, ElseExpr>, Dev>& expr) \
...
#define SYCLEXTRFUNCASSIGNOP(CVQual)                                         \
  ...
  struct FunctorExtractor<                                                   \
      TensorEvaluator<CVQual TensorAssignOp<LHSExpr, RHSExpr>, Dev>> {       \
    FunctorExtractor<TensorEvaluator<LHSExpr, Dev>> lhsExpr;                 \
    FunctorExtractor<TensorEvaluator<RHSExpr, Dev>> rhsExpr;                 \
    FunctorExtractor(                                                        \
        const TensorEvaluator<CVQual TensorAssignOp<LHSExpr, RHSExpr>, Dev>& \
            expr)                                                            \
...
/// TensorEvalToOp, TensorLayoutSwapOp. This is an specialisation without OP so
...
#define SYCLEXTRFUNCREDUCTIONOP(CVQual)                                      \
  ...
  struct FunctorExtractor<TensorEvaluator<                                   \
      CVQual TensorReductionOp<Op, Dims, ArgType, MakePointer_>, Device>> {  \
    typedef TensorEvaluator<                                                 \
        CVQual TensorReductionOp<Op, Dims, ArgType, MakePointer_>, Device>   \
        Evaluator;                                                           \
    ...
    FunctorExtractor(                                                        \
        const TensorEvaluator<                                               \
            CVQual TensorReductionOp<Op, Dims, ArgType, MakePointer_>,       \
            Device>& expr)                                                   \
        : m_dimensions(                                                      \
              DimConstr<Dimensions, Evaluator::NumOutputDims>::getDim(       \
                  expr.dimensions())) {}                                     \
  };
...
#define SYCLEXTRFUNCTUPLEREDUCTIONOP(CVQual)                                   \
  template <typename ReduceOp, typename Dims, typename ArgType,                \
            typename Device>                                                   \
  struct FunctorExtractor<TensorEvaluator<                                     \
      CVQual TensorTupleReducerOp<ReduceOp, Dims, ArgType>, Device>> {         \
    typedef TensorEvaluator<                                                   \
        CVQual TensorTupleReducerOp<ReduceOp, Dims, ArgType>, Device>          \
        Evaluator;                                                             \
    static const int NumOutputDims = Eigen::internal::traits<                  \
        TensorTupleReducerOp<ReduceOp, Dims, ArgType>>::NumDimensions;         \
    typedef typename Evaluator::StrideDims StrideDims;                         \
    typedef typename Evaluator::Index Index;                                   \
    typedef typename Eigen::internal::conditional<                             \
        NumOutputDims == 0, DSizes<Index, 1>,                                  \
        typename Evaluator::Dimensions>::type Dimensions;                      \
    const Dimensions m_dimensions;                                             \
    ...
    EIGEN_STRONG_INLINE const Index stride_mod() const {                       \
      return m_stride_mod;                                                     \
    }                                                                          \
    EIGEN_STRONG_INLINE const Index stride_div() const {                       \
      return m_stride_div;                                                     \
    }                                                                          \
    FunctorExtractor(const TensorEvaluator<                                    \
                     CVQual TensorTupleReducerOp<ReduceOp, Dims, ArgType>,     \
                     Device>& expr)                                            \
        : m_dimensions(DimConstr<Dimensions, NumOutputDims>::getDim(           \
              expr.dimensions())),                                             \
          m_return_dim(expr.return_dim()),                                     \
          m_strides(expr.strides()),                                           \
          m_stride_mod(expr.stride_mod()),                                     \
          m_stride_div(expr.stride_div()) {}                                   \
  };
...
#define SYCLEXTRFUNCCONTRACTCONVOLUTIONOP(CVQual, ExprNode)                   \
  template <typename Indices, typename LhsXprType, typename RhsXprType,       \
            typename Device>                                                  \
  struct FunctorExtractor<TensorEvaluator<                                    \
      CVQual ExprNode<Indices, LhsXprType, RhsXprType>, Device>> {            \
    typedef TensorEvaluator<CVQual ExprNode<Indices, LhsXprType, RhsXprType>, \
                            Device>                                           \
        Evaluator;                                                            \
    typedef typename Evaluator::Dimensions Dimensions;                        \
    const Dimensions m_dimensions;                                            \
    ...
    FunctorExtractor(                                                         \
        const TensorEvaluator<                                                \
            CVQual ExprNode<Indices, LhsXprType, RhsXprType>, Device>& expr)  \
...
/// specialisation of the \ref FunctorExtractor struct when the node type is
/// const TensorSlicingOp. This is an specialisation without OP so it has to be
/// separated.
#define SYCLEXTRFUNCTSLICEOP(CVQual)                                          \
  template <typename StartIndices, typename Sizes, typename XprType,          \
            typename Dev>                                                     \
  struct FunctorExtractor<TensorEvaluator<                                    \
      CVQual TensorSlicingOp<StartIndices, Sizes, XprType>, Dev>> {           \
    FunctorExtractor<TensorEvaluator<XprType, Dev>> xprExpr;                  \
    const StartIndices m_offsets;                                             \
    const Sizes m_dimensions;                                                 \
    FunctorExtractor(                                                         \
        const TensorEvaluator<                                                \
            CVQual TensorSlicingOp<StartIndices, Sizes, XprType>, Dev>& expr) \
        : xprExpr(expr.impl()),                                               \
          m_offsets(expr.startIndices()),                                     \
          m_dimensions(expr.dimensions()) {}                                  \
    EIGEN_STRONG_INLINE const StartIndices& startIndices() const {            \
      return m_offsets;                                                       \
    }                                                                         \
    EIGEN_STRONG_INLINE const Sizes& dimensions() const {                     \
      return m_dimensions;                                                    \
    }                                                                         \
  };
...
#define SYCLEXTRFUNCTSLICESTRIDEOP(CVQual)                                     \
  template <typename StartIndices, typename StopIndices, typename Strides,     \
            typename XprType, typename Dev>                                    \
  struct FunctorExtractor<                                                     \
      TensorEvaluator<CVQual TensorStridingSlicingOp<                          \
    ...
    FunctorExtractor(const TensorEvaluator<                                    \
                     CVQual TensorStridingSlicingOp<StartIndices, StopIndices, \
                                                    Strides, XprType>,         \
                     Dev>& expr)                                               \
        : xprExpr(expr.impl()),                                                \
          m_startIndices(expr.exprStartIndices()),                             \
          m_stopIndices(expr.exprStopIndices()),                               \
          m_strides(expr.strides()) {}                                         \
    EIGEN_STRONG_INLINE const StartIndices& startIndices() const {             \
      return m_startIndices;                                                   \
    }                                                                          \
    EIGEN_STRONG_INLINE const StartIndices& stopIndices() const {              \
      return m_stopIndices;                                                    \
    }                                                                          \
    EIGEN_STRONG_INLINE const StartIndices& strides() const {                  \
      return m_strides;                                                        \
    }                                                                          \
  };
...
// Had to separate TensorReshapingOp and TensorShufflingOp. Otherwise it will be
// mistaken by UnaryCategory
#define SYCLRESHAPEANDSHUFFLEOPFUNCEXT(OPEXPR, FUNCCALL, CVQual)           \
  template <typename Param, typename XprType, typename Dev>                \
  struct FunctorExtractor<                                                 \
      Eigen::TensorEvaluator<CVQual Eigen::OPEXPR<Param, XprType>, Dev>> { \
    FunctorExtractor<Eigen::TensorEvaluator<XprType, Dev>> xprExpr;        \
    const Param m_param;                                                   \
    EIGEN_STRONG_INLINE const Param& param() const { return m_param; }     \
    FunctorExtractor(const Eigen::TensorEvaluator<                         \
                     CVQual Eigen::OPEXPR<Param, XprType>, Dev>& expr)     \
...
#define PADDINGOPFUNCEXT(OPEXPR, FUNCCALL, SCALARFUNCCALL, CVQual)            \
  ...
  struct FunctorExtractor<                                                    \
    ...
    const Param m_param;                                                      \
    typedef                                                                   \
        typename Eigen::TensorEvaluator<CVQual Eigen::OPEXPR<Param, XprType>, \
                                        Dev>::Scalar Scalar;                  \
    const Scalar m_scalar_param;                                              \
    EIGEN_STRONG_INLINE const Param& param() const { return m_param; }        \
    EIGEN_STRONG_INLINE const Scalar& scalar_param() const {                  \
      return m_scalar_param;                                                  \
    }                                                                         \
    FunctorExtractor(const Eigen::TensorEvaluator<                            \
                     CVQual Eigen::OPEXPR<Param, XprType>, Dev>& expr)        \
        : xprExpr(expr.impl()),                                               \
          m_param(expr.FUNCCALL),                                             \
          m_scalar_param(expr.SCALARFUNCCALL) {}                              \
  };
...
/// specialisation of the \ref FunctorExtractor struct when the node type is
/// TensorContractionOp and TensorConcatenationOp for TensorContractionOp the
/// LHS and RHS here are the original one no need to apply condition on their
/// type.
#define SYCLEXTRFUNCCONTRACTCONCAT(OPEXPR, FUNCCALL, CVQual)                  \
  ...
  struct FunctorExtractor<                                                    \
      TensorEvaluator<CVQual OPEXPR<Param, LHSExpr, RHSExpr>, Dev>> {         \
    FunctorExtractor<TensorEvaluator<LHSExpr, Dev>> lhsExpr;                  \
    FunctorExtractor<TensorEvaluator<RHSExpr, Dev>> rhsExpr;                  \
    const Param func;                                                         \
    FunctorExtractor(                                                         \
        const TensorEvaluator<CVQual OPEXPR<Param, LHSExpr, RHSExpr>, Dev>&   \
            expr)                                                             \
        : lhsExpr(expr.left_impl()),                                          \
          rhsExpr(expr.right_impl()),                                         \
          func(expr.FUNCCALL) {}                                              \
...
#define SYCLEXTRFUNCCHIPPINGOP(CVQual)                                        \
  ...
  struct FunctorExtractor<                                                    \
      TensorEvaluator<CVQual TensorChippingOp<DimId, XprType>, Device>> {     \
    ...
    FunctorExtractor(const TensorEvaluator<                                   \
                     CVQual TensorChippingOp<DimId, XprType>, Device>& expr)  \
        : xprExpr(expr.impl()),                                               \
          m_dim(expr.dimId()),                                                \
...
#define SYCLEXTRFUNCIMAGEPATCHOP(CVQual)                               \
  template <DenseIndex Rows, DenseIndex Cols, typename XprType,        \
            typename Device>                                           \
  struct FunctorExtractor<TensorEvaluator<                             \
      CVQual TensorImagePatchOp<Rows, Cols, XprType>, Device>> {       \
    ...
    FunctorExtractor(const TensorEvaluator<Self, Device>& expr)        \
        : xprExpr(expr.impl()),                                        \
          m_patch_rows(expr.xpr().patch_rows()),                       \
          m_patch_cols(expr.xpr().patch_cols()),                       \
          m_row_strides(expr.xpr().row_strides()),                     \
          m_col_strides(expr.xpr().col_strides()),                     \
          m_in_row_strides(expr.xpr().in_row_strides()),               \
          m_in_col_strides(expr.xpr().in_col_strides()),               \
          m_row_inflate_strides(expr.xpr().row_inflate_strides()),     \
          m_col_inflate_strides(expr.xpr().col_inflate_strides()),     \
          m_padding_explicit(expr.xpr().padding_explicit()),           \
          m_padding_top(expr.xpr().padding_top()),                     \
          m_padding_bottom(expr.xpr().padding_bottom()),               \
          m_padding_left(expr.xpr().padding_left()),                   \
          m_padding_right(expr.xpr().padding_right()),                 \
          m_padding_type(expr.xpr().padding_type()),                   \
...
#define SYCLEXTRFUNCVOLUMEPATCHOP(CVQual)                                 \
  template <DenseIndex Planes, DenseIndex Rows, DenseIndex Cols,          \
            typename XprType, typename Device>                            \
  struct FunctorExtractor<TensorEvaluator<                                \
      CVQual TensorVolumePatchOp<Planes, Rows, Cols, XprType>, Device>> { \
    ...
    FunctorExtractor(const TensorEvaluator<Self, Device>& expr)           \
        : xprExpr(expr.impl()),                                           \
          m_patch_planes(expr.xpr().patch_planes()),                      \
          m_patch_rows(expr.xpr().patch_rows()),                          \
          m_patch_cols(expr.xpr().patch_cols()),                          \
          m_plane_strides(expr.xpr().plane_strides()),                    \
          m_row_strides(expr.xpr().row_strides()),                        \
          m_col_strides(expr.xpr().col_strides()),                        \
          m_in_plane_strides(expr.xpr().in_plane_strides()),              \
          m_in_row_strides(expr.xpr().in_row_strides()),                  \
          m_in_col_strides(expr.xpr().in_col_strides()),                  \
          m_plane_inflate_strides(expr.xpr().plane_inflate_strides()),    \
          m_row_inflate_strides(expr.xpr().row_inflate_strides()),        \
          m_col_inflate_strides(expr.xpr().col_inflate_strides()),        \
          m_padding_explicit(expr.xpr().padding_explicit()),              \
          m_padding_top_z(expr.xpr().padding_top_z()),                    \
          m_padding_bottom_z(expr.xpr().padding_bottom_z()),              \
          m_padding_top(expr.xpr().padding_top()),                        \
          m_padding_bottom(expr.xpr().padding_bottom()),                  \
          m_padding_left(expr.xpr().padding_left()),                      \
          m_padding_right(expr.xpr().padding_right()),                    \
