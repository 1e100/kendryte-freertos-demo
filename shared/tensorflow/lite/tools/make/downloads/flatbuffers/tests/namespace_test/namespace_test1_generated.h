...
inline const char* const* EnumNamesEnumInNestedNS() {
  static const char* const names[] = {"A", "B", "C", nullptr};
  return names;
}
...
struct TableInNestedNS FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_foo(int32_t _foo) { return SetField<int32_t>(VT_FOO, _foo, 0); }
  bool Verify(flatbuffers::Verifier& verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int32_t>(verifier, VT_FOO) && verifier.EndTable();
  }
};
