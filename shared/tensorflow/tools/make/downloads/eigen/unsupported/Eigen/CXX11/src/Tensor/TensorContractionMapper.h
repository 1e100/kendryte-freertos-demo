 ...
 */
/// The make pointer class is used by sycl in order to build the mapper class on
/// the device. For other platform the default make pointer is used which is
/// scalar * for CoeffLoader.
...
class SimpleTensorContractionMapper {
 public:
  ...
  enum {
    DirectOffsets =
        CoeffLoader<Tensor, Tensor::RawAccess, MakePointer_>::DirectOffsets
  };
...
class BaseTensorContractionMapper
 ...
 public:
  typedef SimpleTensorContractionMapper<
      Scalar, Index, side, Tensor, nocontract_t, contract_t, packet_size,
      inner_dim_contiguous, Alignment, MakePointer_>
      ParentMapper;
...
class BaseTensorContractionMapper<Scalar, Index, side, Tensor, nocontract_t,
    ...
    : public SimpleTensorContractionMapper<
          Scalar, Index, side, Tensor, nocontract_t, contract_t, 1,
          inner_dim_contiguous, Alignment, MakePointer_> {
 public:
  typedef SimpleTensorContractionMapper<
      Scalar, Index, side, Tensor, nocontract_t, contract_t, 1,
...
class TensorContractionSubMapper {
 public:
  ...
  EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE PacketT loadPacket(Index i,
    ...
    return m_base_mapper.template loadPacket<PacketT, AlignmentType>(
        i + m_vert_offset, j + m_horiz_offset);
  }
