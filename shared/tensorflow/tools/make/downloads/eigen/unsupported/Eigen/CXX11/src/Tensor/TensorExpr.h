...
struct traits<TensorCwiseUnaryOp<UnaryOp, XprType> > : traits<XprType> {
  ...
  static const int NumDimensions = XprTraits::NumDimensions;
  static const int Layout = XprTraits::Layout;
  typedef typename TypeConversion<Scalar, typename XprTraits::PointerType>::type
      PointerType;
};
...
struct traits<
  ...
  typedef typename TypeConversion<
      Scalar,
      typename conditional<
          Pointer_type_promotion<typename Arg2XprType::Scalar, Scalar>::val,
...
struct traits<TensorSelectOp<IfXprType, ThenXprType, ElseXprType> >
  ...
  typedef typename conditional<
      Pointer_type_promotion<typename ThenXprType::Scalar, Scalar>::val,
