...
inline const char* const* EnumNamesColor() {
  static const char* const names[] = {"Red", "Green", "",     "",     "",
                                      "",    "",      "Blue", nullptr};
  return names;
}
...
struct Referrable FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_id(uint64_t _id) { return SetField<uint64_t>(VT_ID, _id, 0); }
...
struct Monster FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<Monster>>* testarrayoftables()
      const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<Monster>>*>(
  ...
  const flatbuffers::Vector<flatbuffers::Offset<Referrable>>*
  vector_of_referrables() const {
    return GetPointer<
        const flatbuffers::Vector<flatbuffers::Offset<Referrable>>*>(
        VT_VECTOR_OF_REFERRABLES);
  }
  flatbuffers::Vector<flatbuffers::Offset<Referrable>>*
  mutable_vector_of_referrables() {
    return GetPointer<flatbuffers::Vector<flatbuffers::Offset<Referrable>>*>(
        VT_VECTOR_OF_REFERRABLES);
  }
...
struct MonsterBuilder {
  ...
  void add_vector_of_referrables(
      flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Referrable>>>
...
inline flatbuffers::Offset<Monster> CreateMonsterDirect(
    ...
    flatbuffers::Offset<MyGame::InParentNamespace> parent_namespace_test = 0,
    const std::vector<flatbuffers::Offset<Referrable>>* vector_of_referrables =
        nullptr,
    uint64_t single_weak_reference = 0,
    const std::vector<uint64_t>* vector_of_weak_references = nullptr,
    const std::vector<flatbuffers::Offset<Referrable>>*
  ...
  return MyGame::Example::CreateMonster(
      ...
      test, test4 ? _fbb.CreateVectorOfStructs<Test>(*test4) : 0,
      testarrayofstring
      ...
      testarrayofstring2
          ...
          : 0,
      testarrayofsortedstruct
          ? _fbb.CreateVectorOfStructs<Ability>(*testarrayofsortedstruct)
          : 0,
      ...
      vector_of_referrables
          ? _fbb.CreateVector<flatbuffers::Offset<Referrable>>(
                *vector_of_referrables)
          : 0,
...
inline void Monster::UnPackTo(
  ...
  };
  {
    ...
    if (_e) {
      ...
      for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
        _o->vector_of_referrables[_i] = flatbuffers::unique_ptr<ReferrableT>(
    ...
    if (_e) {
      ...
      for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
        _o->vector_of_strong_referrables[_i] =
            std::unique_ptr<ReferrableT>(_e->Get(_i)->UnPack(_resolver));
      }
    }
  };
  {
  ...
  };
  {
    ...
    if (_e) {
      ...
      for (flatbuffers::uoffset_t _i = 0; _i < _e->size();
           _i++) {  // vector resolver, std::unique_ptr
        if (_resolver)
          (*_resolver)(
...
inline flatbuffers::Offset<Monster> CreateMonster(
  ...
  return MyGame::Example::CreateMonster(
      ...
      _non_owning_reference, _vector_of_non_owning_references);
}
...
inline const flatbuffers::TypeTable* ColorTypeTable() {
  static const flatbuffers::TypeCode type_codes[] = {
      ...
      {flatbuffers::ET_CHAR, 0, 0},
      {flatbuffers::ET_CHAR, 0, 0}};
  static const flatbuffers::TypeFunction type_refs[] = {ColorTypeTable};
