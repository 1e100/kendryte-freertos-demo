...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4) Rapunzel FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  Rapunzel() { memset(this, 0, sizeof(Rapunzel)); }
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4) BookReader FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  BookReader() { memset(this, 0, sizeof(BookReader)); }
...
struct AttackerT : public flatbuffers::NativeTable {
  ...
  AttackerT() : sword_attack_damage(0) {}
};
...
struct Movie FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_main_character_type(Character _main_character_type) {
    return SetField<uint8_t>(VT_MAIN_CHARACTER_TYPE,
                             static_cast<uint8_t>(_main_character_type), 0);
  }
  const void* main_character() const {
    return GetPointer<const void*>(VT_MAIN_CHARACTER);
  }
  template <typename T>
  const T* main_character_as() const;
...
inline flatbuffers::Offset<Movie> CreateMovieDirect(
  ...
  return CreateMovie(
      _fbb, main_character_type, main_character,
  ...
  };
  {
    ...
    if (_e) {
      ...
      for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
        _o->characters[_i].type = (Character)_e->Get(_i);
      }
    }
  };
  {
